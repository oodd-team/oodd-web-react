...
const Naver: React.FC = () => {
    ...
    const redirectUri = encodeURIComponent(import.meta.env.VITE_DEV_DOMAIN ? import.meta.env.VITE_DEV_DOMAIN + '/auth/naver/callback' : 'http://localhost:8080/auth/naver/callback');
