...
const Naver: React.FC = () => {
    ...
    const redirectUri = encodeURIComponent(import.meta.env.VITE_DEV_DOMAIN ? import.meta.env.VITE_DEV_DOMAIN + '/auth/naver/callback' : 'https://localhost:3000/auth/naver/callback');
